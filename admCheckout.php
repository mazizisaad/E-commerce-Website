...
<body>
	<div id="wrapper">
      ...
      <div id="body">
      	...
      	<div id="postage">
       <?php
		$sql0 = "SELECT * FROM payment WHERE delivery = 'Postage' AND tracking = 'null' ORDER BY pay_date";
		...
		echo "<table align='center' cellpadding='5'>
				...
				while($data = mysqli_fetch_array($row)){
				    echo "<form action=trackingStatus.php method=post>";
					echo "<tr align='center'>";
					echo "<td>"  . "<input type=text name=ref readonly style='border:none; text-align:center; background:transparent' size=5 value=" . $data['ref'] . " </td>";
					...
					echo "<td><input type=text name=tracking autocomplete=off value="  .$data['tracking'] . " </td>";
	...
	?>
        ...
        <div id="pickup">
        	<?php
		$sql1 = "SELECT * FROM payment WHERE delivery = 'Self Pickup' AND tracking = 'null' ORDER BY pay_date";
		...
		echo "<table align='center' cellpadding='5'>
				...
				<th>Product ID/ Product Name/ Product Brand</th>
				<th>Quatity</th>
				<th colspan=2>Pickup Status</th>";
				while($data1 = mysqli_fetch_array($row1)){
				    echo "<form action=trackingStatus.php method=post>";
					echo "<tr align='center'>";
					echo "<td>"  . "<input type=text name=ref readonly style='border:none; text-align:center; background:transparent' size=5 value=" . $data1['ref'] . " </td>";
					...
					echo "<td><input name=tracking type=text autocomplete=off value="  .$data1['tracking'] . " </td>";
					echo "<td><input type=submit name=update value=Update></td>";
					echo "</form>";
				}
		echo "</table>";
