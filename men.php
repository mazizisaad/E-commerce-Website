...
<div id="wrapper">
  ...
  <div id="body">
<div id="menTitle">
 	<h1 id="menDept">Men Department</h1>
    <ul>
 ...
 <div id="menContent">
     ...
     <div id="items">
<?php
	 $sql0 = "SELECT * FROM product WHERE p_brand = 'Empayar Kuku Besi' AND p_type = 'Men' ORDER BY id";
	...
	?>
     ...
     <br>
     <a href="#menDept" class="smoothScroll">Go to top</a>
   </div>
   <div id="AbstraxClothing">
     <h2 id="abstrax"><img src="button/right.png" width="20px" height="20px"/>Abstrax Clothing</h2>
     <div id="items">
     <?php
	 $sql0 = "SELECT * FROM product WHERE p_brand = 'Abstrax' AND p_type = 'Men' ORDER BY id";
		$row0 = mysqli_query($dbconn, $sql0);
		while($data = mysqli_fetch_array($row0)){
		echo "<div id='productTable'>";	
			echo "<form action=addToCart.php method=post>";
   ...
   <div id="legitClothing">
     ...
     <div id="items">
     <?php
	 $sql0 = "SELECT * FROM product WHERE p_brand = 'Legit' AND p_type = 'Men' ORDER BY id";
		$row0 = mysqli_query($dbconn, $sql0);
		while($data = mysqli_fetch_array($row0)){
		echo "<div id='productTable'>";	
			echo "<form action=addToCart.php method=post>";
   ...
   <div id="akudesignClothing">
     ...
     <div id="items">
     <?php
	 $sql0 = "SELECT * FROM product WHERE p_brand = 'Akudesign' AND p_type = 'Men' ORDER BY id";
		$row0 = mysqli_query($dbconn, $sql0);
		while($data = mysqli_fetch_array($row0)){
		echo "<div id='productTable'>";	
			echo "<form action=addToCart.php method=post>";
   ...
   <div id="rareClothing">
     ...
     <div id="items">
     <?php
	 $sql0 = "SELECT * FROM product WHERE p_brand = 'Rare' AND p_type = 'Men' ORDER BY id";
		$row0 = mysqli_query($dbconn, $sql0);
		while($data = mysqli_fetch_array($row0)){
		echo "<div id='productTable'>";	
			echo "<form action=addToCart.php method=post>";
